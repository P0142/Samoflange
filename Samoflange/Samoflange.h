...
typedef NTSTATUS(NTAPI* pRtlCreateProcessParametersEx)(PRTL_USER_PROCESS_PARAMETERS*, PCUNICODE_STRING, PCUNICODE_STRING, 
    PCUNICODE_STRING, PCUNICODE_STRING, PVOID, PCUNICODE_STRING, PCUNICODE_STRING, PCUNICODE_STRING, PCUNICODE_STRING, ULONG);

typedef NTSTATUS(NTAPI* pNtCreateUserProcess)(PHANDLE, PHANDLE, ACCESS_MASK, ACCESS_MASK, PCOBJECT_ATTRIBUTES, 
...
// Thread stuff
typedef NTSTATUS(NTAPI* pNtOpenThread)(PHANDLE ThreadHandle, ACCESS_MASK DesiredAccess, POBJECT_ATTRIBUTES ObjectAttributes, PCLIENT_ID ClientId);
...
typedef NTSTATUS(NTAPI* pNtResumeThread)(HANDLE ThreadHandle, PULONG PreviousSuspendCount);
